        ...
        <>
            ...
            {!sidebarOpen && (
                <button
                    ...
                    className="fixed top-4 left-4 z-50 md:hidden w-9 h-9 rounded-xl bg-[var(--bg-card)] border border-[var(--border)] flex items-center justify-center text-[var(--text-muted)] shadow-lg"
                >
            ...
            <motion.aside
                ...
                className={`
                    fixed left-0 top-0 h-screen bg-[var(--bg-secondary)] border-r border-[var(--border)] z-40 flex flex-col overflow-hidden
                    ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}
                    transition-transform md:transition-none
                `}
                style={{ width: sidebarOpen ? 256 : undefined }}
            >
                {/* Top */}
                ...
                {!sidebarOpen && (
                    <div className="hidden md:flex justify-center py-2 border-b border-[var(--border-glass)]">
                        <button
                            onClick={() => setSidebarOpen(true)}
                    ...
                    <div className={`flex items-center ${sidebarOpen ? 'gap-3' : 'justify-center'}`}>
                        ...
                        {sidebarOpen && (
                            <button
                                ...
                                className="w-7 h-7 rounded-lg hover:bg-[var(--status-cancelled-bg)] flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--status-cancelled)] flex-shrink-0"
                                title="Logout"
                            >
