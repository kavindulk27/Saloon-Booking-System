                ...
                >
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex justify-end">
                            <Link to="/forgot-password" className="text-xs text-[#D4AF37] hover:text-[#F0D060]">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <div className="mt-6 text-center">
                        {!isManagementPath && (
                            <p className="text-gray-400 text-sm">
                                ...
                                <Link to="/register" className="text-[#D4AF37] hover:text-[#F0D060] font-medium transition-colors">
                                    Create one now
                                </Link>
                            </p>
                        )}
                        ...
                        <div className={`grid ${isAdminPath ? 'grid-cols-2' : 'grid-cols-1'} gap-2`}>
                            {demoLogins.map(d => (
                                <button
                                    ...
                                    className="text-[10px] bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg py-2 px-1 text-gray-300 hover:text-white transition-all capitalize"
                                >
                                    {d.label}
                                </button>
                            ))}
